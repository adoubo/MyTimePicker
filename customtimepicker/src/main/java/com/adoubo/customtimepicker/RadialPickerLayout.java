...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = MyTimePickerDialog.HOUR_INDEX;
    private static final int MINUTE_INDEX = MyTimePickerDialog.MINUTE_INDEX;
    private static final int AMPM_INDEX = MyTimePickerDialog.AMPM_INDEX;
    private static final int ENABLE_PICKER_INDEX = MyTimePickerDialog.ENABLE_PICKER_INDEX;
    private static final int AM = MyTimePickerDialog.AM;
    private static final int PM = MyTimePickerDialog.PM;
